            ...
            <div className="text-white my-3 my-md-5 py-md-5">
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                    <div className="col-12 col-sm-12 col-lg-6">
                        <img src={img} className="d-block mx-lg-auto img-fluid" width={650} alt="Bootstrap Themes" loading="lazy" />
                    </div>
                    <div className="col-lg-6 me-auto">
                        <h2 className="display-4 fw-bold text-white lh-1 mb-5">Why Choose Us?</h2>
                        ...
                        <h4 className="fw-bold text-prm d-flex align-items-center gap-2"><span style={{fontSize:'32px'}} className="material-symbols-outlined">
                            done
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-start mt-0 mt-md-4">
